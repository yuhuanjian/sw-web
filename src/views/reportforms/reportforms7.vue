  ...
  <div ref="main" class="dashboard-container">
    ...
    <TableWrap>
      <el-table :data="tableData" border stripe style="width: 100%" height="100%">
        ...
        <el-table-column prop="killNum" label="屠宰数量（头）" :show-overflow-tooltip="true"/>
        <el-table-column prop="disposeSickPigNum" label="病害猪处理数量（头）" :show-overflow-tooltip="true"/>
        <el-table-column prop="illWeight" label="病害猪产品（公斤）" :show-overflow-tooltip="true"/>
        <el-table-column prop="disposeCause" label="处理原因" :show-overflow-tooltip="true"/>
        <el-table-column prop="qualifiedNum" label="合格数量（头）" :show-overflow-tooltip="true"/>
...
export default {
  ...
  methods: {
    ...
    exportReportForms: _.debounce(function () {
      window.location.href = exportReportForms7(
