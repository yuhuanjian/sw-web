<template>
  <div ref="main" class="dashboard-container detail-con">
    ...
    <div ref="search">
      <headerxq title="检疫详情" routepush="out" :header-list="headerList" />
    </div>
    ...
    <TableWrap>
      ...
      >
        <el-tab-pane label="异常详情" name="first" style="height:100%">
          <el-table
            :data="dataTables3"
            border
            style="width: 100%"
...
import { postQuarantinequeryAbnormalInfo } from '@/api/jyzyy'
