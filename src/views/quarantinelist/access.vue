...
<template>
  <div ref="main" class="dashboard-container">
    ...
    <div ref="action" class="action-wrap">
      ...
      <div>
        <el-button
          v-has="'allowEnterQuarantine:export'"
          type="primary"
    ...
    <TableWrap>
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" min-width="150">
          <template slot-scope="scope">
            <el-button
              v-if="scope.row.quarantineStatus === 1"
              v-has="'allowEnterQuarantine:add'"
              type="text"
              size="small"
            ...
            <el-button
              v-if="scope.row.quarantineStatus != 1"
              v-has="'allowEnterQuarantine:detail'"
              type="text"
              size="small"
              @click="handleClick(scope.row)"
            >检疫详情</el-button>
            <el-button
              v-if="scope.row.quarantineStatus !== 3"
              v-has="'allowEnterQuarantine:abnormalInput'"
              type="text"
              size="small"
    ...
    <el-dialog title="新增异常" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
  ...
  methods: {
    ...
    exportZY: _.debounce(function() {
      window.location.href = GetQuarantineexportQuarantineInfo(
        ...
        }&wholesaler=${this.formSearch.wholesaler}&quarType=1&branchId=${this.formSearch.branchId}`
      )
    }, 500),
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          postQuarantineSaveAbnormalInfo({
            ...
            epidemicMaterials: Number(this.ruleForm.epidemicMaterials),
            abnormalNum: Number(this.ruleForm.abnormalNum),
            orderId: this.orderId,
            sequence: 1,
            illWeight: Number(this.ruleForm.illWeight)
          }).then(res => {
